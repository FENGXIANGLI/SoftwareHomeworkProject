...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="http://static.show.wepiao.com/pc/js/ie8-responsive-file-warning.js?v=94dc0e9"></script>
    <![endif]-->
            ...
            <div class="row">
                <div class="">
                    <div class="navbar-header">
                        ...
                        <a href="/" class="navbar-brand weipiao-title">
                            <img class="logoImg" src="http://static.show.wepiao.com/pc/img/logoMsg.png" width="147" height="70"></a>
                    </div>
                </div>
                <!-- 城市筛选 start -->
                <div class="region">
                    ...
                    <div class="regionChooseWindow">
                        <div class="regionTop hotCity">
                            <p>
                                当前
                                <a href="/index.php?r=item/search">全国</a>
                                共有
                        ...
                        <div class="regionCont active clearfix"></div>
                    </div>
                </div>
                <!-- 城市筛选 end -->
                <div class="" id="wepiao-navbar-collapse-1">
                    <div class="menuCon clearfix">
                        <div class='navdrop'>
                            <a href="/"  class="totle deploy on menu_item">
                                <span>演出</span>
                            </a>
                            <div class="filmCinemaList">
                                <a href="http://wepiao.com/index.php?r=item/search">
                                    <span>演出票</span>
                                </a>
                                <a href="http://wepiao.com/index.php?r=venue/list">
                                    <span>场馆</span>
                                </a>
                            </div>
                        </div>
                        <div class='navdrop'>
                            <a href="http://wepiao.com/index.php?r=movie"  target="_blank"  class="totle menu_item">
                                <span>电影</span>
                            </a>
                        </div>
                        <div class='navdrop'>
                            <a href="http://wepiao.com/index.php?r=user/order"  class="my-ticket menu_item">
                                <span>我的微票儿</span>
                            </a>
                        </div>
        ...
        <div class="row">
            <div class="thumbnail">
                ...
                <div class="caption text-center">
                    <h3 class="un">
                    <span class="">
                        <img src="http://static.show.wepiao.com/pc/img/women.png"></span>
                    </h3>
                    <p>
            ...
            <div class="col-md-2">
                <nav class="my_center_sidenav">
                    <ul class="nav text-right">
                        <li>
                            <a href="http://wepiao.com/index.php?r=user/order#profile-top">我的订单</a>
                        </li>
                        <li>
                            <a href="http://wepiao.com/index.php?r=user/attention#profile-top">我的关注</a>
                        </li>
                        <li class="active">
                            <a href="http://wepiao.com/index.php?r=user/profile#profile-top">个人信息</a>
                        </li>
                        <li>
                            <a href="http://wepiao.com/index.php?r=user/deliveryAddr#profile-top">收货地址</a>
                        </li>
                    </ul>
                </nav>
            </div>
                        ...
                        <div class="row minfo">
                            <div class="col-md-12">
                                <dl>
                                    <dt>昵称：</dt>
                                    <dd>
                                        <input type="text" name="profile[name]" class="form-control" maxlength="10" value="WP146304977240" ></dd>
                                </dl>
                                <dl>
                                    <dt>姓名</dt>
                                    <dd>
                                        <input type="text" name="profile[realName]" class="form-control" value="丰翔" ></dd>
                                </dl>
                                <dl>
                                    <dt>生日</dt>
                                    <dd>
                                    ...
                                    <dd>
                                        <div class="radio">
                                            <label class="radio-inline">
                                                <input type="radio" name="profile[gender]" id="gender_1" value="1" >男性</label>
                                            <label class="radio-inline">
                                                <input type="radio" name="profile[gender]" id="gender_2" value="2" checked>女性</label>
                                        </div>
                                    </dd>
                                </dl>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <ul>
                                    <li data-id="ff8080814a7ad6f1014a7adb6b540002" class="">
                                        <span>演唱会</span>
                                        <input type="hidden" name="interest_type[]" value=""></li>
        ...
        <div class="weixin footerItem">
            <div class="icon">
                <div class="block">
                    <span class="wx"></span>
                    <a class="ecode e1">
                        <img src="http://static.show.wepiao.com/pc/img/f_wpr_ecode.png" width="78" height="84"></a>
                </div>
                <div class="block">
                    <span class="wpr"></span>
                    <a class="ecode e2">
                        <img src="http://static.show.wepiao.com/pc/img/f_app_ecode.png" width="78" height="84"></a>
                </div>
            </div>
            <div class="instru">
