...
<html lang="zh-cn">
    <head>
        ...
        <script src="http://static.show.wepiao.com/pc/js/libs/bootstrap.min.js?v=94dc0e9"></script>
        <script src="http://static.show.wepiao.com/pc/js/libs/uploadify/jquery.uploadify.js?v=94dc0e9"></script>

        <!--[if lt IE 9]><script src="http://static.show.wepiao.com/pc/js/ie8-responsive-file-warning.js?v=94dc0e9"></script><![endif]-->
        ...
        <script>var staticUri='http://static.show.wepiao.com', staticVersion='94dc0e9', token='20059f24b8fceafb2b2d4948d7dfb641',customApp=[], apiUrl='http://www.wepiao.com/api', userId='2d5fc12dcc52dba05aad69e07f49a625', thumbUri = "", curCity=null, isStatic=0,uploadUrl= "http://static.show.wepiao.com/uploading";</script>
    ...
    <div class="container user-top">
        <div class="row">
            <div class="thumbnail">                
                <img width="130" height="130" src="http://static.show.wepiao.com/thumb/auto/80/107//pc/img/defaultpic.gif" class="img-circle">
...
<div class="infobox">
    ...
    <form id="profileForm" action="/index.php?r=user/profile" method="post">
        <input type="hidden" name="YII_CSRF_TOKEN" value="e9677859caf56a52dd43d709c67e9a3375128353" />
    <div class="row minfo">
        <div class="col-md-12">
            <dl>
                <dt>昵称：</dt>
